...
\begin{frame}
\frametitle{\textbf{2. Problem B: Steady-state Advection-diffusion equation}}
...
\begin{frame}
	\frametitle{\textbf{2. Problem A: FDM}}
...
\begin{align*}
	\frac{1}{\Delta x^2} \pp{-T_{i+1} + 2T_{i} - T_{i-1}} + \frac{1}{\Delta y^2} \pp{-T_{i+n_x} + 2T_{i} - T_{i-n_x}} &= 10  \ \forall i \in \Omega
	\\
...
\begin{frame}
	\frametitle{\textbf{2. Problem B: FDM}}
...
\def\ncolsb{35}
\begin{frame}
	\frametitle{\textbf{2. Sparsity pattern of the matrix}}
